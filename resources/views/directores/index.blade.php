...
<div class="container mx-auto px-4 py-6">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <a href="{{ route('directores.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full md:w-auto text-center flex items-center justify-center">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
                                <a href="{{ route('directores.edit', $director) }}" class="text-blue-500 hover:text-blue-700 flex items-center">
                                ...
                                <form action="{{ route('directores.destroy', $director) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-red-500 hover:text-red-700 flex items-center" onclick="return confirm('¿Estás seguro?')">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="text-center py-8">
        <p class="text-gray-500">No hay directores registrados.</p>
    </div>
    @endif
</div>
@endsection